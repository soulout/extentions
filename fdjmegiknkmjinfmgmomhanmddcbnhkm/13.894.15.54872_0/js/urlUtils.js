...
(function (UrlUtils) {
    var ParsedUrl = (function () {
        ...
        ParsedUrl.prototype.getQueryString = function () {
            return this.parts.queryString;
        };
        ParsedUrl.prototype.getFragmentId = function () {
            return this.parts.fragmentId;
        };
        return ParsedUrl;
    }());
    ...
    var ParsedQueryString = (function () {
        ...
        ParsedQueryString.prototype.getParamIndex = function (name) {
            return this.nameValues.findIndex(function (nv) {
                return nv.name === name;
            });
        };
    ...
    function appendParamStringToUrl(url, paramString) {
        ...
        return [url, ~url.indexOf("?") ? "&" : "?", paramString].join("");
    }
    UrlUtils.appendParamStringToUrl = appendParamStringToUrl;
})(UrlUtils || (UrlUtils = {}));
