    ...
    var e = gingerModule.load("widget.correctionBubble", function() {
        ...
        var a = function(e, t, n) {
            ...
            for (var l = 0; l < s.length; l++) {
                ...
                $gingerWidgetJquery(M).get(0).appendChild(c);
            }
            C.show();
            ...
            var $ = $gingerWidgetJquery(W).outerWidth();
        ...
        var L = function() {
            ...
            M = $gingerWidgetJquery("<gdiv class='ginger-module-correctionBubble-body'></gdiv>").appendTo(W);
...
(function() {
    var e = gingerModule.load("widget.highlighters.ghost", function() {
        ...
        var s = function() {
            ...
            var e = $gingerWidgetJquery(c).position();
            var t = window.devicePixelRatio || 1;
            if ($gingerWidgetJquery(u).css("box-sizing") === "border-box") {
                $gingerWidgetJquery(u).css("height", c.outerHeight / t);
                $gingerWidgetJquery(u).css("width", c.outerWidth / t);
            } else {
                $gingerWidgetJquery(u).css("height", $gingerWidgetJquery(c).height() / t);
                $gingerWidgetJquery(u).css("width", $gingerWidgetJquery(c).width() / t);
            }
            var n = parseInt($gingerWidgetJquery(c).css("z-index"));
            if (!n) n = 1;
            if (n < 2) n = 2;
            var r = $gingerWidgetJquery(c).data("gingerPositionCache");
            if (!r) {
                r = $gingerWidgetJquery(c).css("position");
                $gingerWidgetJquery(c).data("gingerPositionCache", r);
            }
            var i = r;
            if (i == "fixed") {
                $gingerWidgetJquery(u).css("position", "fixed");
                $gingerWidgetJquery(u).css("z-index", n - 1);
                $gingerWidgetJquery(c).css("z-index", n);
                ...
                $gingerWidgetJquery(c).css("position", "relative");
                $gingerWidgetJquery(u).css("position", "absolute");
                $gingerWidgetJquery(u).css("top", e.top);
                $gingerWidgetJquery(u).css("left", e.left);
                if (o) {
        ...
        var p = function(e, t) {
            var n = $gingerWidgetJquery("<" + d + " />").get(0);
            n.id = "gws-" + e.id;
        ...
        var m = function() {
            ...
            var e = $gingerWidgetJquery(c).css("background");
            var t = $gingerWidgetJquery(c).css("background-image");
            var n = $gingerWidgetJquery(c).css("background-color");
            var r = t == "none" && n == "rgba(0, 0, 0, 0)" ? true : false;
            if (!r) {
                $gingerWidgetJquery(c).get(0).style.setProperty("background", "none", "important");
                $gingerWidgetJquery(c).data("gingerBackgroundCache", e);
            }
            var i = c;
            if (c.childNodes.length && /mentions-texteditor__content/.test(c.childNodes[0].className)) {
                i = c.childNodes[0];
            }
            $gingerWidgetJquery(u).css("color", $gingerWidgetJquery(i).css("color"));
            $gingerWidgetJquery(u).css("borderRadius", $gingerWidgetJquery(i).css("borderRadius"));
            $gingerWidgetJquery(u).css("border", $gingerWidgetJquery(i).css("border"));
            $gingerWidgetJquery(u).css("borderColor", "rgba(0,0,0,0)");
            $gingerWidgetJquery(u).css("boxSizing", $gingerWidgetJquery(i).css("boxSizing"));
            $gingerWidgetJquery(u).css("height", $gingerWidgetJquery(i).css("height"));
            $gingerWidgetJquery(u).css("paddingTop", $gingerWidgetJquery(i).css("paddingTop"));
            $gingerWidgetJquery(u).css("paddingLeft", $gingerWidgetJquery(i).css("paddingLeft"));
            $gingerWidgetJquery(u).css("paddingBottom", $gingerWidgetJquery(i).css("paddingBottom"));
            $gingerWidgetJquery(u).css("marginTop", $gingerWidgetJquery(i).css("marginTop"));
            $gingerWidgetJquery(u).css("marginLeft", $gingerWidgetJquery(i).css("marginLeft"));
            $gingerWidgetJquery(u).css("marginRight", $gingerWidgetJquery(i).css("marginRight"));
            $gingerWidgetJquery(u).css("marginBottom", $gingerWidgetJquery(i).css("marginBottom"));
            $gingerWidgetJquery(u).css("width", $gingerWidgetJquery(i).css("width"));
            $gingerWidgetJquery(u).css("fontFamily", $gingerWidgetJquery(i).css("fontFamily"));
            $gingerWidgetJquery(u).css("direction", $gingerWidgetJquery(i).css("direction"));
            $gingerWidgetJquery(u).css("fontSize", $gingerWidgetJquery(i).css("fontSize"));
            $gingerWidgetJquery(u).css("textAlign", $gingerWidgetJquery(i).css("textAlign"));
            $gingerWidgetJquery(u).css("letterSpacing", $gingerWidgetJquery(i).css("letterSpacing"));
            $gingerWidgetJquery(u).css("fontWeight", $gingerWidgetJquery(i).css("fontWeight"));
            $gingerWidgetJquery(u).css("whiteSpace", $gingerWidgetJquery(i).css("whiteSpace"));
            $gingerWidgetJquery(u).css("overflowWrap", $gingerWidgetJquery(i).css("overflowWrap"));
            var o = $gingerWidgetJquery(i).css("lineHeight");
            $gingerWidgetJquery(u).css("lineHeight", o);
            $gingerWidgetJquery(i).css("lineHeight", o);
            var a = i.offsetWidth - i.clientWidth;
            var g = parseFloat($gingerWidgetJquery(i).css("paddingRight"));
            if (g) {
                $gingerWidgetJquery(u).css("paddingRight", g + a - 2);
            } else {
                $gingerWidgetJquery(u).css("paddingRight", a);
            }
        ...
        var h = function() {
            u.scrollTop($gingerWidgetJquery(c).scrollTop());
            u.scrollLeft($gingerWidgetJquery(c).scrollLeft());
        };
        var n = function() {
            var e = $gingerWidgetJquery(c).css("position");
            if (o) {
                u = $gingerWidgetJquery("<div class='ginger-module-highlighter ginger-module-highlighter-ghost'></div>").insertAfter($gingerWidgetJquery(c));
            } else if (e == "static" || e == "relative") {
                u = $gingerWidgetJquery("<div class='ginger-module-highlighter ginger-module-highlighter-ghost'></div>").insertBefore($gingerWidgetJquery(c));
            } else {
                u = $gingerWidgetJquery("<div class='ginger-module-highlighter ginger-module-highlighter-ghost'></div>").insertAfter($gingerWidgetJquery(c));
            }
        };
        ...
        var w = function() {
            var e = $gingerWidgetJquery(c).data("gingerBackgroundCache");
            if (e) {
                $gingerWidgetJquery(c).css("background", e);
            }
            $gingerWidgetJquery(c).css("position", "");
            $gingerWidgetJquery(c).css("z-index", "");
            l.events.listen.off("mutation.ghostUpdate");
            $gingerWidgetJquery(c).off("blur", s);
            $gingerWidgetJquery(c).off("scroll", h);
            ...
            e = setTimeout(function() {
                ...
                if (e) {
                    ...
                    if (n.correction.checkType === "shallow") {
                        ...
                        gingerModule.get("widget.correctionBubble").show(t, n, W);
                        a = e;
                    }
                } else {
                    if (a) {
            ...
            try {
                v = {
                    ...
                    unit: {
                        ...
                        handleCorrectionBubbleResult: W,
                        flush: O
                    }
                };
                    ...
                    if (u[s].pages) {
                        for (var l in u[s].pages) {
                            if (l === "*" || n.href.indexOf(l) >= 0) {
                                $gingerWidgetJquery.extend(true, r, u[s].pages[l]);
                            }
                        }
                    }
                    if (t && u[s].selectors) {
                        for (var c in u[s].selectors) {
                            if ($gingerWidgetJquery(t).is(c)) {
                                $gingerWidgetJquery.extend(true, r, u[s].selectors[c]);
                            }
                        }
                    }
                }
