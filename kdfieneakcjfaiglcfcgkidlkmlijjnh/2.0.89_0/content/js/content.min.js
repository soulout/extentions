...
(function() {
    var e = gingerModule.load("widget.highlighters.ghost", function() {
        ...
        var c = function() {
            if (!$gingerWidgetJquery(d).is(":visible")) {
                return;
            }
            var e = $gingerWidgetJquery(d).position();
            var t = window.devicePixelRatio || 1;
            if ($gingerWidgetJquery(s).css("box-sizing") === "border-box") {
                $gingerWidgetJquery(s).css("height", d.outerHeight / t);
                $gingerWidgetJquery(s).css("width", d.outerWidth / t);
            } else {
                $gingerWidgetJquery(s).css("height", $gingerWidgetJquery(d).height() / t);
                $gingerWidgetJquery(s).css("width", $gingerWidgetJquery(d).width() / t);
            }
            var n = parseInt($gingerWidgetJquery(d).css("z-index"));
            if (!n) n = 1;
            if (n < 2) n = 2;
            var r = $gingerWidgetJquery(d).data("gingerPositionCache");
            if (!r) {
                r = $gingerWidgetJquery(d).css("position");
                $gingerWidgetJquery(d).data("gingerPositionCache", r);
            }
            var i = r;
            if (i == "fixed") {
                $gingerWidgetJquery(s).css("position", "fixed");
                $gingerWidgetJquery(s).css("z-index", n - 1);
                $gingerWidgetJquery(d).css("z-index", n);
                $gingerWidgetJquery(s).css("top", e.top);
                $gingerWidgetJquery(s).css("left", e.left);
            } else if (i == "relative") {
                $gingerWidgetJquery(s).css("position", "absolute");
                $gingerWidgetJquery(s).css("top", e.top);
                $gingerWidgetJquery(s).css("left", e.left);
                if (o) {
                    $gingerWidgetJquery(s).css("top", e.top);
                ...
                $gingerWidgetJquery(d).css("position", "relative");
                $gingerWidgetJquery(s).css("position", "absolute");
                $gingerWidgetJquery(s).css("top", e.top);
                $gingerWidgetJquery(s).css("left", e.left);
                if (o) {
        ...
        var h = function(e, t) {
            ...
            for (var a = 0; a < o.length; a++) {
                ...
                if (o[a].correction && !o[a].correction.ignored) {
                    var l = false;
                    if (t.indexOf(o[a].correction.id) === -1 && !$gingerWidgetJquery(s).find("#" + f + "-" + o[a].correction.id).length) {
                        l = true;
                    }
        ...
        var m = function() {
            ...
            var e = $gingerWidgetJquery(d).css("background");
            var t = $gingerWidgetJquery(d).css("background-image");
            var n = $gingerWidgetJquery(d).css("background-color");
            var r = t == "none" && n == "rgba(0, 0, 0, 0)" ? true : false;
            if (!r) {
                $gingerWidgetJquery(d).get(0).style.setProperty("background", "none", "important");
                $gingerWidgetJquery(d).data("gingerBackgroundCache", e);
            }
            var i = d;
            if (d.childNodes.length && /mentions-texteditor__content/.test(d.childNodes[0].className)) {
                i = d.childNodes[0];
            }
            $gingerWidgetJquery(s).css("color", $gingerWidgetJquery(i).css("color"));
            $gingerWidgetJquery(s).css("borderRadius", $gingerWidgetJquery(i).css("borderRadius"));
            $gingerWidgetJquery(s).css("border", $gingerWidgetJquery(i).css("border"));
            $gingerWidgetJquery(s).css("borderColor", "rgba(0,0,0,0)");
            $gingerWidgetJquery(s).css("boxSizing", $gingerWidgetJquery(i).css("boxSizing"));
            $gingerWidgetJquery(s).css("height", $gingerWidgetJquery(i).css("height"));
            $gingerWidgetJquery(s).css("paddingTop", $gingerWidgetJquery(i).css("paddingTop"));
            $gingerWidgetJquery(s).css("paddingLeft", $gingerWidgetJquery(i).css("paddingLeft"));
            $gingerWidgetJquery(s).css("paddingBottom", $gingerWidgetJquery(i).css("paddingBottom"));
            $gingerWidgetJquery(s).css("marginTop", $gingerWidgetJquery(i).css("marginTop"));
            $gingerWidgetJquery(s).css("marginLeft", $gingerWidgetJquery(i).css("marginLeft"));
            $gingerWidgetJquery(s).css("marginRight", $gingerWidgetJquery(i).css("marginRight"));
            $gingerWidgetJquery(s).css("marginBottom", $gingerWidgetJquery(i).css("marginBottom"));
            $gingerWidgetJquery(s).css("width", $gingerWidgetJquery(i).css("width"));
            $gingerWidgetJquery(s).css("fontFamily", $gingerWidgetJquery(i).css("fontFamily"));
            $gingerWidgetJquery(s).css("direction", $gingerWidgetJquery(i).css("direction"));
            $gingerWidgetJquery(s).css("fontSize", $gingerWidgetJquery(i).css("fontSize"));
            $gingerWidgetJquery(s).css("textAlign", $gingerWidgetJquery(i).css("textAlign"));
            $gingerWidgetJquery(s).css("letterSpacing", $gingerWidgetJquery(i).css("letterSpacing"));
            $gingerWidgetJquery(s).css("fontWeight", $gingerWidgetJquery(i).css("fontWeight"));
            $gingerWidgetJquery(s).css("whiteSpace", $gingerWidgetJquery(i).css("whiteSpace"));
            $gingerWidgetJquery(s).css("overflowWrap", $gingerWidgetJquery(i).css("overflowWrap"));
            var o = $gingerWidgetJquery(i).css("lineHeight");
            $gingerWidgetJquery(s).css("lineHeight", o);
            $gingerWidgetJquery(i).css("lineHeight", o);
            var g = i.offsetWidth - i.clientWidth;
            var a = parseFloat($gingerWidgetJquery(i).css("paddingRight"));
            if (a) {
                $gingerWidgetJquery(s).css("paddingRight", a + g - 2);
            } else {
                $gingerWidgetJquery(s).css("paddingRight", g);
            }
            var c = $gingerWidgetJquery(i).data("gingerBackgroundCache");
            if (c) {
                $gingerWidgetJquery(s).css("background", c);
            }
            $gingerWidgetJquery(s).css({
                color: "rgba(0,0,0,0)"
            });
            $gingerWidgetJquery(s).css({
                display: "block"
            ...
            if (gingerModule.get("widget.utils").isRichTextElement(i)) {
                $gingerWidgetJquery(s).css("white-space", "pre-wrap");
            } else {
                $gingerWidgetJquery(s).css("white-space", $gingerWidgetJquery(i).css("white-space"));
            }
            gingerModule.get("widget.ghostModifiers").process(i, s);
        };
        var e = function(e) {
        ...
        var p = function() {
            s.scrollTop($gingerWidgetJquery(d).scrollTop());
            s.scrollLeft($gingerWidgetJquery(d).scrollLeft());
        };
        var n = function() {
            var e = $gingerWidgetJquery(d).css("position");
            if (o) {
                s = $gingerWidgetJquery("<div class='ginger-module-highlighter ginger-module-highlighter-ghost'></div>").insertAfter($gingerWidgetJquery(d));
            } else if (e == "static" || e == "relative") {
                s = $gingerWidgetJquery("<div class='ginger-module-highlighter ginger-module-highlighter-ghost'></div>").insertBefore($gingerWidgetJquery(d));
            } else {
                s = $gingerWidgetJquery("<div class='ginger-module-highlighter ginger-module-highlighter-ghost'></div>").insertAfter($gingerWidgetJquery(d));
            }
        };
        var r = function() {
            return $gingerWidgetJquery(s).find(f);
        };
        var i = function(e) {
            if (e) {
                $gingerWidgetJquery(s).show();
            } else {
                $gingerWidgetJquery(s).hide();
            }
            g = !!e;
        };
        var w = function() {
            var e = $gingerWidgetJquery(d).data("gingerBackgroundCache");
            if (e) {
                $gingerWidgetJquery(d).css("background", e);
            }
            $gingerWidgetJquery(d).css("position", "");
            $gingerWidgetJquery(d).css("z-index", "");
            l.events.listen.off("mutation.ghostUpdate");
            $gingerWidgetJquery(d).off("blur", c);
            $gingerWidgetJquery(d).off("scroll", p);
            $gingerWidgetJquery(s).remove();
        };
        var b = function(e) {
            l = e;
            d = l.element;
            o = t(d);
            $gingerWidgetJquery(d).blur(c);
            d.addEventListener("scroll", p);
        ...
        var $ = function(e, t) {
            try {
                ...
                if (e === "ignoreAll") {
                    ...
                    r = f(t.sentenceId);
                    n = b(t.correctionId);
                    var l = N(r, n.UXFrgFrom, n.UXFrgTo + 1);
                    var d = 0;
                    for (var g = 0; g < r.correction.Corrections.length; g++) {
                    ...
                    if (s[c].pages) {
                        for (var l in s[c].pages) {
                            if (l === "*" || n.href.indexOf(l) >= 0) {
                                $gingerWidgetJquery.extend(true, r, s[c].pages[l]);
                            }
                        }
                    }
                    if (t && s[c].selectors) {
                        for (var d in s[c].selectors) {
                            if ($gingerWidgetJquery(t).is(d)) {
                                $gingerWidgetJquery.extend(true, r, s[c].selectors[d]);
                            }
                        }
                    }
                }
